...
public:
	...
	//2pick
	static int32_t duel_save_pick_deck(lua_State *L);
	static int32_t duel_is_player_need_to_pick_deck(lua_State *L);
	static int32_t duel_get_start_count(lua_State *L);
	//millux
	...
	static int32_t card_get_link_marker(lua_State *L);
	...
	static int32_t duel_move_turn_count(lua_State *L);
	static int32_t duel_get_cards_in_zone(lua_State *L);
	static int32_t duel_xyz_summon_by_rose(lua_State *L);
	...
	static int32_t card_is_able_to_decrease_attack_as_cost(lua_State *L);
	static int32_t card_is_able_to_decrease_defense_as_cost(lua_State *L);
	...
	static int32_t duel_get_disable_field(lua_State *L);
	...
	static int32_t duel_announce_card_silent(lua_State *L);
